...
F="$LI383 --method newton --ns 16,32,32 --steps 40 --chunk 20"
...
sub ns_p1 40 "" scripts/relax.py $F --p 1 --out $O/p1
sub ns_p3 90 "" scripts/relax.py $F --p 3 --out $O/p3
sub ns_p4 180 "" scripts/relax.py $F --p 4 --out $O/p4
