...
#     plt.plot(np.abs(np.array(divergence_trace) - np.array(divergence_trace)[0]), label="Divergence")
#     # plt.plot(np.abs(np.array(energy_diff_trace) - timesteps * np.array(velocity_trace[1:])**2) / np.array(velocity_trace[1:])**2, label="Energy difference")
#     plt.plot(force_trace, label="Force")
#     plt.yscale("log")
#     plt.legend()
#     plt.show()
...
#     plt.plot(timesteps, label="Timestep")
#     plt.yscale("log")
#     plt.legend()
#     plt.show()
