...
"what runs" sections of `docs/source/concepts/PRODUCTION.md` where the two disagree.
...
`docs/source/concepts/PRODUCTION.md` needs a revision pass once 3.1 and 3.2 are decided; it is
