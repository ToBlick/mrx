...
- **`preconditioner_lessons.md`** — what is unfinished, in priority order, plus the
...
- `preconditioner_lessons.md` / `handoff_2026-08-13_gpu_cluster.md` — the
...
- `preconditioner_lessons.md` — closed the k>0 space in 2026-08-14. **Verdict
...
- `w7x_vacuum_bfield_handoff.md`, `gvec_h5_vacuum_comparison.md`,
  `preconditioner_lessons.md` — vacuum-field and harmonic-form work.
