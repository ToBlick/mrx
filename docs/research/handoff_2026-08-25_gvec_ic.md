> **Status:** superseded by docs/source/concepts/gvec_mrx_interface.md and relaxation_ic_2026-08-25.md
...
**`docs/source/concepts/gvec_mrx_interface.md`** — the GVEC → MRX export contract, written for
