...
def test_clebsch_ic_is_divergence_free_and_near_force_balance(w7x_seq):
    ...
    # ||div B|| 3.0e-16, wall part 0, ||F||_M 3.255e-2 with the map's
    # coefficients L2-projected from the series (the Greville interpolant of
    # the series gave 1.624e-2 on this smoke mesh, the gridded export
    # 1.888e-2 through the projection route); band at ~1.6x.
    assert F_norm < 5.2e-2
