...
#   plain float32     MRX_DTYPE=float32 MRX_RESIDUAL_DTYPE=float32   (the float32-only configuration of a
#                                                                     TPU and of an Apple GPU, tol sqrt(eps);
#                                                                     Metal needs MRX_X64=0 on top, docs/source/mps.md)
#
